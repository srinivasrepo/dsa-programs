...
public class InsertionSort {
    ...
    // second while loop iterates upto "j = (-1) or (original copy of small lefty index-1)" && checks if key is smaller than lefties in each while loop
    ...
    // now after whole while loop, replce the j="(-1+1 val) or (original copy of small lefty val)" with our key
