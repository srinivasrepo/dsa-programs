...
<pre>
 ...
 2. [1][1] -- repeated ele => memo will work not work because it uses weights / distance
 3. td memo dp -> yes keep the small and break the rec of big -- or bu tabulation
...
public class MinimumPathSum {
    ...
    private static void rec(int[][] grid, int[][] dp, int i) { // or pass m, n as params
        int m = grid.length;
        int n = grid[0].length;
        if (i == m-1) {
