 ...
 * <p>
 * <code>
 * <p> SUGGESTIONS FOR FINDING DP PATTERNS:
 * <p>1. Visualize few examples in mind & play around with them
 * <p>2. We see repetitive sub-problem i.e already calculated expression => So, try to implement a sub-problem which can be used to solve the whole problem using loop or recursion
 ...
 * <p>5. Tracking & storing the previous sub-problems values in each recursive / loop approach to use them & skip if it is already calculated
 ...
 * <p>9. Single directional graph with lot of nodes but not a bi-directional.
 ...
 * <p>Egs:
 * <p>* Fibonacci series or nth fibonacci number,
 ...
 * <p>* Stacking boxes l,w,h -- all available options to stack the boxes like a-box can stack on b-box, c-box can stack on a-box etc i.e it can be a loop too i.e now focus the biggest box as base / root node in each option repeat all created options to find the answer or just keep track of the answer using an extra var like maxLen
 * </code>
 *
 *
