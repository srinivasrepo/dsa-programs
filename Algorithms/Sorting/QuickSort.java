...
public class QuickSort{
    ...
    public static void sort(int[] items, int low, int high){
        ...
        // ---------- at beginning consider that no small element in 0 index. so start i less than 0 ----------
        int i = low-1; //and int j = low;
        // pivot can be anything but to be consistent all over the recursions, take the last element of the array or sub-array
