...
public class SwapNodesInPairs {
    ...
    public static void main(String[] args) {
        ...
        ListNode res = swapPairsUsingPrev(head, headBackup);
        ...
        res = swapPairsUsingPrevAndCurr(head, headBackup);
    ...
    public static ListNode swapPairsUsingPrevAndCurr(ListNode head, ListNode headBackup) {
        ...
        while (curr != null && curr.next != null) {
            ...
            // manipulate nodes and reverse pairs
            ...
            // sec=[2, |1, "2", 1, "2", 1, "2", 1,.........|]
            // curr=[1, |sec|] = [1, |2, 1, "2", 1, "2", 1, "2", 1,.........|] && prev=dummy=[-1,|curr|] = [-1, |1, 2, 1, "2", 1, "2", 1, "2", 1,.........|]  --  i.e CircularLinkedList or infinite SingleLinkedList as "sec" manipulates "curr", "prev", "dummy"and "head"
            ...
            //curr=[1, |3, 4, 5|] && sec=[2, 1, |3, 4, 5|] && prev=dummy=[-1, 1, |3, 4, 5|] --- i.e curr manipulates "sec", "prev" & "dummy"
